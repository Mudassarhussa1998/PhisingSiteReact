...
export default function Facebook() {
    ...
    return (
        <>
            <div className="w-full min-h-screen bg-[#f0f2f5] px-4 pt-8 md:px-[150px] md:pt-[50px]">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Left Section */}
                    <div className="text-center md:text-start md:pl-[55px]">
                        ...
                        <svg
                            ...
                            <p className="text-lg md:text-3xl md:pl-7 md:w-[540px]">
                    ...
                    <div className="flex flex-col items-center">
                        <form onSubmit={handleSubmit}>
                            <div className="shadow-xl p-4 mt-4 md:mt-[50px] w-full max-w-md rounded-xl bg-white">
                                ...
                                <button
                                    className="w-full max-w-[200px] mx-auto h-[50px] font-bold text-md bg-[#42b72a] text-white rounded"
                                    type="button"
                                >
                                    Create new account
                                </button>
